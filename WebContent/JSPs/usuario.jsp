							...
							Apellido: ${p1.apellido}<br> Correo: ${p1.correo}<br>
									<div class="wrap-login100">
										<div class="login100-form-title"
											style="background-image: url(/Proyectov6/img/bg-02.jpg);">
				...
				<table class="container">
					...
					<c:forEach items="${telefono}" var="telefono">
						...
						<tr>
							...
							<td><h3>
									<a
										href="ActualizarTelefono?codigo=${telefono.codigo}&numero=${telefono.numero}&tipo=${telefono.tipo}&operadora=${telefono.operadora}&correo=${p1.correo}&contrasena=${p1.contrasena}">Modiicar</a>
								</h3></td>
							<td><h3>
									<a
